...
public partial class Olly {
    private Node MakeDialogue() {
        var node1 = new Node(
            "...",
            new[] { Tr("About you", "너에 관해"), Tr("Overlayer", "오버레이어"), Tr("Source Code", "소스코드"), Tr("Face", "얼굴") },
            eye: Eye.Normal,
            mouth: Mouth.Normal,
        ...
        var node2 = new Node(
            ...
            new[] { "...", Tr("How did you come to be?", "어쩌다가 만들어졌어?"), Tr("Who drew you?", "널 누가 그려준거야?") },
            eye: Eye.Normal,
        ...
        var node4 = new Node(
            ...
            new[] { Tr("What does that mean?", "그게 어떤 의미야?"), Tr("How can I help?", "어떻게 도울 수 있어?") },
            eye: Eye.Normal,
            mouth: Mouth.Open,
            eyebrow: Eyebrow.Normal
        );
        ...
        var node4_2 = new Node(
            ...
            new[] { "...", Tr("Where is the source?", "소스 코드는 어디에 있어?") },
            eye: Eye.Normal,
            mouth: Mouth.Smile,
            eyebrow: Eyebrow.Normal
        );

        var node4_2_1 = new Node(
        ...
        node4_1.Next[0] = node1;
        node4_2.Next[0] = node1;
        node4_2.Next[1] = node4_2_1;
        node4_2_1.Next[0] = node1;
