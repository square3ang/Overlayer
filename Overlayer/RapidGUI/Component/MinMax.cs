...
public class MinMaxInt : MinMax<int>, IMinMaxLerp<int> {
    public int LerpUnclamped(float t) {
        return Mathf.FloorToInt(Mathf.LerpUnclamped(min, max, t));
    }
}
...
public class MinMaxVector2 : MinMax<Vector2>, IMinMaxLerp<Vector2> {
    public Vector2 LerpUnclamped(float t) {
        return Vector2.LerpUnclamped(min, max, t);
    }
}
...
public class MinMaxVector4 : MinMax<Vector4>, IMinMaxLerp<Vector4> {
    public Vector4 LerpUnclamped(float t) {
        return Vector4.LerpUnclamped(min, max, t);
    }
}
...
public class MinMaxVector2Int : MinMax<Vector2Int>, IMinMaxLerp<Vector2Int> {
    public Vector2Int LerpUnclamped(float t) {
        return Vector2Int.FloorToInt(Vector2.LerpUnclamped(min, max, t));
    }
}
...
public class MinMaxVector3Int : MinMax<Vector3Int>, IMinMaxLerp<Vector3Int> {
    public Vector3Int LerpUnclamped(float t) {
        return Vector3Int.FloorToInt(Vector3.LerpUnclamped(min, max, t));
    }
}
