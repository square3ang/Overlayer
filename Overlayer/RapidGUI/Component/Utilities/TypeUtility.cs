...
public static partial class TypeUtility {
    private static readonly string ListInterfaceStr = "IList`1";

    public static Type GetListInterface(Type type) {
        return type.GetInterface(ListInterfaceStr);
    }

    public static bool IsList(Type type) {
        return GetListInterface(type) != null;
    }

    private static readonly Dictionary<Type, bool> multiLineTable = [];
    ...
    private static readonly Dictionary<Type, bool> isRecursiveTable = [];
