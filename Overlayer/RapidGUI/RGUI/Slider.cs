...
public static partial class RGUI {
    private delegate object SliderFunc(object v, object min, object max);
    ...
    public static object Slider(object obj, object min, object max, Type type, string label, ref bool isOpen,
    ...
    */
    ...
    public static object Slider(object obj, object min, object max, Type type, string label,
        params GUILayoutOption[] options) {
    ...
    private static readonly Dictionary<Type, SliderFunc> sliderFuncTable = new() {
        { typeof(int), SliderInt },
        { typeof(float), SliderFloat }
    };

    private static SliderFunc DispatchSliderFunc(Type type) {
    ...
    private static object SliderInt(object v, object min, object max) {
        ...
        var ret = (int)GUILayout.HorizontalSlider((int)v, (int)min, (int)max, ns1, ns2,
    ...
    private static object SliderFloat(object v, object min, object max) {
        var ns1 = new GUIStyle(GUI.skin.horizontalSlider);
        var ns2 = new GUIStyle(GUI.skin.horizontalSliderThumb);
        ...
        var ret = GUILayout.HorizontalSlider((float)v, (float)min, (float)max, ns1, ns2,
            GUILayout.MinWidth(SliderSetting.minWidth));
