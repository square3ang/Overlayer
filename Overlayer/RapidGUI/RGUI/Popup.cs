...
public static partial class RGUI {
    private static int popupControlId;
    private static readonly PopupWindow popupWindow = new();
    ...
    public static int PopupOnLastRect(int selectionIndex, string[] displayOptions, int mouseButton = -1,
        ...
        return Popup(GUILayoutUtility.GetLastRect(),
            mouseButton, selectionIndex, displayOptions, null,
            label, tooltips);
    }

    public static int PopupOnLastRect(int selectionIndex, string[] displayOptions, Texture2D[] images,
        int mouseButton = -1,
        string label = "", Dictionary<string, string> tooltips = null) {
        return Popup(GUILayoutUtility.GetLastRect(),
    ...
    public class PopupWindow : IDoGUIWindow {
        ...
        private static readonly int PopupWindowId = "Popup".GetHashCode();
        ...
        public void DoGUIWindow() {
            ...
            GUI.ModalWindow(PopupWindowId, wrect, id => {
                    ...
                    if (showTooltip) Drawer.Tooltip(tooltip, true);
                }
                , label, npopup);
        }
