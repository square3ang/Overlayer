...
public static partial class RGUI {
    private static object RecursiveSlider(object obj, object min, object max) {
        return DoRecursiveSafe(obj, () => DoRecursiveSlider(obj, min, max));
    }

    private static object DoRecursiveSlider(object obj, object min, object max) {
    ...
    private static void DoSlider(object obj, object min, object max, Type type) {
